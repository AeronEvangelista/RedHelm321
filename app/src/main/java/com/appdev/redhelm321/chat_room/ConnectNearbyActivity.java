...
public class ConnectNearbyActivity extends AppCompatActivity {
    ...
    CardView cv_messagingInterface;
    CardView cv_discoverInterface;
...
//                cv_messagingInterface.setVisibility(View.VISIBLE);
        ...
        et_messageInput = findViewById(R.id.et_messageInput);

        cv_discoverInterface = findViewById(R.id.cv_discoverInterface);
        cv_messagingInterface = findViewById(R.id.cv_messagingInterface);
        ...
        lv_messageList = findViewById(R.id.lv_messageList);

        btn_sendMessage = findViewById(R.id.btn_sendMessage);
        btn_sendMessage.setOnClickListener(v -> btn_sendMessage_OnClick());

        btn_scanDevices = findViewById(R.id.btn_scanDevices);
        btn_scanDevices.setOnClickListener(v -> btn_scanDevices_OnClick());

        btn_group = findViewById(R.id.btn_group);
        btn_group.setOnClickListener(v -> btn_group_OnClick());
